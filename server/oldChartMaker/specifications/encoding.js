...
const findMissing = require("../chartMaker/findMissing").findMissing;
...
module.exports = (
  ...
  switch (numHeaders) {
    case 1:
      ...
      return chartObj;
    case 2:
      extractedHeaders = findQuantitative(
        extractedHeaders,
        data,
        headerFreq,
        command
    ...
    case 3:
      ...
      if (extractedHeaders.length !== 3) {
        chartObj.errMsg(
          "I tried to make a " + intent + ", but i coldn't find the right data"
        );
      }
