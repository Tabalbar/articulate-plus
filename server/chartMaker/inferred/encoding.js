...
module.exports = (chartObj, intent, extractedHeaders, data, headerFreq, command) => {
    ...
    switch (numHeaders) {
        case 1:
            ...
            return chartObj
        case 2:
            quantitativeFound = findQuantitative(extractedHeaders, data, headerFreq, command, 2)
            ...
            break
        case 3:
            quantitativeFound = findQuantitative(extractedHeaders, data, headerFreq, command, 3)
