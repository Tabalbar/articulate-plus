    ...
    return (
        ...
        <ReactResizeDetector>
            ...
            <Draggable
                ...
                defaultPosition={{ x: props.charts[props.index].x, y: props.charts[props.index].y }}
                ...
                >
                    <div  className="handle" style={{ cursor: "move", width: "auto" }}>
                        {/* {`${width} x ${height}`} */}
                        <Box borderTopRadius="sm" bg="teal.800" width={width + 200} height="full"  >
                            <IconButton
                                colorScheme="red"
                                borderRadius="sm"
                                // ml={"38rem"}
                        ...
                        <VegaLite width={width- 200} height={height - 200} spec={props.specification} data={{ table: props.data }} />
                    </div>
